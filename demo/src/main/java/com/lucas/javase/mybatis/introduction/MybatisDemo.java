...
import com.lucas.javase.mybatis.introduction.po.User;
...
public class MybatisDemo {
	...
	Log log=LogFactory.getLog(MybatisDemo.class);
	/**
	...
	public void init() throws Exception {
		...
		log.info("还有构建者模式，去创建SqlSessionFactory对象");
	...
	public void testInsertUser() {
		...
		User user = new User();
		user.setUsername("lucas.li");
		user.setSex("男");
		user.setAddress("casco");
		user.setBirthday("1994-10");
